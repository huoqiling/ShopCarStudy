...
import com.zhangxin.study.view.SwipeCardLayout;
...
public class SwipeCardActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SwipeCardLayout scl_layout = (SwipeCardLayout) findViewById(R.id.scl_layout);
        ...
        scl_layout.setAdapter(new SwipeCardLayout.CardAdapter<CardEntity>(data) {
            ...
            @Override
            public void bindData(CardEntity data, final View convertView) {
                ...
                TextView btnLike = convertView.findViewById(R.id.btnLike);
                btnLike.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        scl_layout.rightOut((SwipeCardLayout.SwipeLayout) convertView,350);
                    }
                });
